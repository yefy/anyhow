...
pub fn err4() -> anyhow::Result<()> {
    err1_3().map_err(anyhow_context!("4_1"))?;
    Ok(())
}

pub fn err4_2() -> anyhow::Result<()> {
    err4().map_err(anyhow_context!("4_2:{}", "4_2"))?;
    Ok(())
}

pub fn err4_3() -> anyhow::Result<()> {
    let err = anyhow!("4_3");
    err4_2().map_err(anyhow_context!(err))?;
    Ok(())
}

pub fn err4_4() -> anyhow::Result<()> {
    err4_3().map_err(anyhow_context!())?;
    Ok(())
}
